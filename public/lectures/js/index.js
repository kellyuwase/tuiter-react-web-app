const aDom = document.getElementById(elementId:"a");
const bDom = document.getElementById(elementId:"b");
const a = parseInt(aDom.value);
const b = parseInt(bDom.value);
console.log(a,b)
const cDom = document.getElementById(elementId:"c");
cDom.value = a+b;
...
document.write("<h2>List using for loop</h2>")
let average=0;
let total=0;
document.write("<ul>")
for (let i=0; i<grades.length; i++){
